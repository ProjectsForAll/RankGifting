...
//        String hexRegexOthers = "([<][#]([A-Fa-f0-9]{6})[>])";
    ...
    public static BaseComponent[] color(String message) {
        ...
        while (matcher.find()) {
            ...
            if (start > lastEnd) {
                builder.append(new net.md_5.bungee.api.chat.TextComponent(message.substring(lastEnd, start)));
            }
            ...
            net.md_5.bungee.api.chat.TextComponent coloredText = new net.md_5.bungee.api.chat.TextComponent(message.substring(end));
